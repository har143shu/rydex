      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            {/* Title */}
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight leading-none text-zinc-900">
              ...
              <span className="relative inline-block">
                ...
                <motion.div
                  ...
                  className="absolute left-0 right-0 -bottom-1 h-0.5 origin-left bg-zinc-900"
                />
              </span>
            </h2>
        ...
        <div
          ref={sliderRef}
          className="flex gap-5 overflow-x-auto scroll-smooth pt-20 pb-4 px-1"
          ...
          {VEHICLE_CATEGORIES.map((c, i) => {
            ...
            return (
              <motion.div
                ...
                className="min-w-[220px] sm:min-w-[260px] flex-shrink-0 cursor-pointer"
              >
                <motion.div
                  animate={{
                  ...
                  className="rounded-3xl border p-6 sm:p-7 h-full overflow-hidden"
                >
                  <motion.div
                    animate={{
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1.5 mb-5 text-[9px] font-black uppercase tracking-[0.18em]"
                  >
                    <Sparkles size={8} />
                    {c.tag}
                  </motion.div>
