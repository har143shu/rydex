                ...
                {Nav_Items.map((i, index) => {
                  ...
                  return (
                    <Link
                      key={index}
                      href={href}
                      className="px-6 py-4 text-sm font-medium transition text-gray-400 hover:text-white hover:bg-white/5"
                    >
                      {i}
                    </Link>
                  );
          ...
          <>
            ...
            >
              <div className="p-5">
                ...
                {userData.role != "partner" && (
                  <div
                    className="w-full flex items-center gap-3 pt-3 pb-3 pl-3 py-0 hover:bg-gray-100 rounded-xl"
                    // onClick={() => router.push("/user/bookings")}
                  >
                    Bookings
                    <ChevronRight size={16} className="ml-auto" />
