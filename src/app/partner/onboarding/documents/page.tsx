...
import { ArrowLeft, FileCheck, Loader2Icon, UploadCloud } from "lucide-react";
...
function Page() {
  ...
  const handleDocs = (doc: DocType, file: File | null) => {
    //iska kaam sirf docs state me value set karne ka h
    if (!file) {
      return;
    }
        ...
        <div className="mt-8 space-y-5">
          ...
          >
            ...
            <input
              ...
              accept="image/*,.pdf"
              onChange={(e) => {
                handleDocs("aadhar", e.target.files?.[0] ?? null);
              }}
            />
          </motion.label>
          ...
          >
            ...
            <input
              ...
              accept="image/*,.pdf"
              onChange={(e) => {
                handleDocs("license", e.target.files?.[0] ?? null);
              }}
            />
          </motion.label>
          ...
          >
            ...
            <input
              ...
              accept="image/*,.pdf"
              onChange={(e) => {
                handleDocs("rc", e.target.files?.[0] ?? null);
              }}
            />
          </motion.label>
